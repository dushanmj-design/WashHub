...
export default function SupervisorIntake({ onSubmit, isLoading }: SupervisorIntakeProps) {
  ...
  return (
    <form onSubmit={handleFormSubmit} className="bg-white rounded-xl shadow-lg border border-slate-200 overflow-hidden w-full flex flex-col md:flex-row text-slate-800 font-sans">
      ...
      {/* Right Column */}
      <div className="w-full lg:w-[35%] bg-[#f8fafc] flex flex-col p-6 sm:p-8 border-l border-slate-200">
